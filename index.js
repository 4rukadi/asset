    ...
    o = {
      79: function (t) {
        t.exports = (function () {
          ...
          function o(t, e) {
            return (
              (o = (e || document).querySelectorAll(t)),
          ...
          return (
            (e.prototype.create = function () {
              ...
              const t = this.$el;
              return (
                (this._closers = o("[data-a11y-dialog-hide]", this.$el)
                  .filter(function (e) {
                    return (
                      e.closest('[aria-modal="true"], [data-a11y-dialog]') === t
                    );
                  })
            ...
            (e.prototype._bindKeypress = function (e) {
              ...
              (s && s.closest('[aria-modal="true"]') !== this.$el) ||
                (this.shown &&
                  "Escape" === e.key &&
                ...
                this.shown &&
                  ...
                  (function (e, s) {
                    ...
                    s.shiftKey && 0 === a
                      ? (n[n.length - 1].focus(), s.preventDefault())
                      : s.shiftKey ||
                        a !== n.length - 1 ||
                        (n[0].focus(), s.preventDefault());
                  })(this.$el, e));
            }),
  ...
  (n.n = (t) => {
    ...
    (() => {
      ...
      const o = {
        ...
        delete:
          "<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'><path d='M0 0h24v24H0z' stroke='none'/><path d='M4 7h16M10 11v6M14 11v6M5 7l1 12a2 2 0 002 2h8a2 2 0 002-2l1-12M9 7V4a1 1 0 011-1h4a1 1 0 011 1v3'/></svg>",
        ...
        Apple:
          "<svg fill='currentColor' width='18' height='18' role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'><path d='M12.152 6.896c-.948 0-2.415-1.078-3.96-1.04-2.04.027-3.91 1.183-4.961 3.014-2.117 3.675-.546 9.103 1.519 12.09 1.013 1.454 2.208 3.09 3.792 3.039 1.52-.065 2.09-.987 3.935-.987 1.831 0 2.35.987 3.96.948 1.637-.026 2.676-1.48 3.676-2.948 1.156-1.688 1.636-3.325 1.662-3.415-.039-.013-3.182-1.221-3.22-4.857-.026-3.04 2.48-4.494 2.597-4.559-1.429-2.09-3.623-2.324-4.39-2.376-2-.156-3.675 1.09-4.61 1.09zM15.53 3.83c.843-1.012 1.4-2.427 1.245-3.83-1.207.052-2.662.805-3.532 1.818-.78.896-1.454 2.338-1.273 3.714 1.338.104 2.715-.688 3.559-1.701'></path></svg>",
        Facebook:
        ...
        Reddit:
          "<svg fill='currentColor' width='18' height='18' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'><path d='M12 0A12 12 0 000 12a12 12 0 0012 12 12 12 0 0012-12A12 12 0 0012 0zm5.01 4.744c.688 0 1.25.561 1.25 1.249a1.25 1.25 0 01-2.498.056l-2.597-.547-.8 3.747c1.824.07 3.48.632 4.674 1.488.308-.309.73-.491 1.207-.491.968 0 1.754.786 1.754 1.754 0 .716-.435 1.333-1.01 1.614a3.111 3.111 0 01.042.52c0 2.694-3.13 4.87-7.004 4.87-3.874 0-7.004-2.176-7.004-4.87 0-.183.015-.366.043-.534A1.748 1.748 0 014.028 12c0-.968.786-1.754 1.754-1.754.463 0 .898.196 1.207.49 1.207-.883 2.878-1.43 4.744-1.487l.885-4.182a.342.342 0 01.14-.197.35.35 0 01.238-.042l2.906.617a1.214 1.214 0 011.108-.701zM9.25 12C8.561 12 8 12.562 8 13.25c0 .687.561 1.248 1.25 1.248.687 0 1.248-.561 1.248-1.249 0-.688-.561-1.249-1.249-1.249zm5.5 0c-.687 0-1.248.561-1.248 1.25 0 .687.561 1.248 1.249 1.248.688 0 1.249-.561 1.249-1.249 0-.687-.562-1.249-1.25-1.249zm-5.466 3.99a.327.327 0 00-.231.094.33.33 0 000 .463c.842.842 2.484.913 2.961.913.477 0 2.105-.056 2.961-.913a.361.361 0 00.029-.463.33.33 0 00-.464 0c-.547.533-1.684.73-2.512.73-.828 0-1.979-.196-2.512-.73a.326.326 0 00-.232-.095z'/></svg>",
        TikTok:
      ...
      function r() {
        ...
        if (IntersectionObserver && t) {
          let e = new IntersectionObserver(
            function (t) {
              t.forEach((t) => {
                t.isIntersecting && !t.target.classList.contains("_aos-done")
                  ? t.target.classList.add("_aos-done")
                  : t.target.classList.remove("_aos-done");
              });
            },
      ...
      class h {
        ...
        init(t) {
          this.LS &&
            (this.LS[t]
              ? (this.data = JSON.parse(this.LS[t]))
              : (this.data = {}));
        }
        set(t, e) {
          (this.data[t] = e),
      ...
      const v = "3.1.2",
        g = p.get("version");
      g !== v && (console.log(v, g), m.show(), p.set("version", v));
      var w = new h("adb_tool"),
        y = w.get("results"),
        f = w.get("settings");
      (f && null != f.showCF) ||
        ((f = { collapseAll: !0, showCF: !0, showSL: !0 }),
        w.set("settings", f));
      var b = "";
      y || (y = []);
      var k = document.getElementById("test_log"),
        _ = new (function (t) {
          ...
          (e.snack = document.createElement("div")),
            ...
            (e.autoCloseTimeout =
              t.autoClose && "number" == typeof t.autoCloseTimeout
                ? t.autoCloseTimeout
                : 3e3),
            (e.reset = function () {
              (e.message.innerHTML = ""),
      ...
      var M = {
        ...
        blocked: 0,
        notblocked: 0,
        cosmetic_test: { static: null, dynamic: null },
        script: { ads: null, pagead: null, partnerads: null },
        hosts: {},
      };
      const L = document.getElementById("test");
      async function C(t, e, s, n, a) {
        const i = new AbortController(),
          c = { method: "HEAD", mode: "no-cors", signal: i.signal },
          l = setTimeout(() => {
            i.abort();
          }, 8e3);
        M.total += 1;
        ...
        (r.onclick = () => {
          ...
          e.appendChild(r);
        try {
          await fetch("https://" + t + "/fakepage.html", c, l, s, e)
            .then((e) => {
              console.log(e),
                "basic" == e.type && 200 == e.status
                  ? ((r.innerHTML = o.v + "<span>" + t + "</span>"),
                    (M.blocked += 1),
                    Object.assign(M.hosts[n][a], { [t]: !0 }),
                    (b += "<br> " + t + " - blocked"))
                  : ((s.style.background = "var(--red)"),
                    (r.innerHTML = o.x + "<span>" + t + "</span>"),
                    (M.notblocked += 1),
                    Object.assign(M.hosts[n][a], { [t]: !1 }),
                    (b += "<br> " + t + " - not blocked"));
            })
            .catch((e) => {
              console.log(e),
      ...
      function E(t, e) {
        document.querySelectorAll(".test_collapse").forEach((o) => {
          1 == t
            ? o.parentElement.classList.add("show")
                ...
                void setTimeout(function () {
                  ...
                  (M.cosmetic_test.static =
                    ...
                    document
                      ...
                      .classList.add(
                        M.cosmetic_test.static ? "_bg-green" : "_bg-red"
                      );
                    ...
                    setTimeout(function () {
                      ...
                      (M.cosmetic_test.dynamic =
                        ...
                        document
                          ...
                          .classList.add(
                            M.cosmetic_test.dynamic ? "_bg-green" : "_bg-red"
                          ),
                        T();
                    }, 500);
                })()
              ...
              t.push(
                (function () {
                  ...
                  (M.script.ads = "undefined" == typeof s_test_ads),
                    ...
                    (M.script.partnerads =
                      "undefined" == typeof s_test_partnerads),
                    e.classList.add(M.script.ads ? "_bg-green" : "_bg-red"),
                    o.classList.add(M.script.pagead ? "_bg-green" : "_bg-red"),
                    (M.blocked +=
                      (M.script.ads ? 1 : 0) + (M.script.pagead ? 1 : 0)),
                    (M.notblocked +=
                      (M.script.ads ? 0 : 1) + (M.script.pagead ? 0 : 1)),
                    k.appendChild(t),
                    (t.innerHTML =
                      "<div>script_ads : " +
                      M.script.ads +
                ...
                Object.keys(e).forEach((s) => {
                  if ("default" != s) {
                    ...
                    Object.keys(a).forEach((e) => {
                      ...
                      if (
                        ((h.innerHTML =
                          "<span class='test_collapse'>" + m + e + "</span>"),
                        h.appendChild(u),
                        r % 2 == 0 ? l.appendChild(h) : c.appendChild(h),
                        r++,
                        Object.assign(M.hosts[s], { [e]: {} }),
      ...
      function T() {
        var t = (100 / M.total) * M.blocked,
          e =
            t > 30 ? (t > 60 ? "var(--green)" : "var(--orange)") : "var(--red)";
          ...
          document.querySelectorAll("button[data-r]").forEach((t) => {
            t.addEventListener("click", () => {
              !(function (t) {
                ...
                a.href
                  ? (URL.revokeObjectURL(a.href), setTimeout(i, 1e3))
                  : i();
      ...
      document.addEventListener("DOMContentLoaded", function () {
        new s(), new c(), new l(), new r(), console.log(f);
        for (const t in f)
          try {
            console.log(`${t}: ${f[t]}`);
        ...
        O(),
          A().then(() => {
            E(f.collapseAll, !0),
              setTimeout(() => {
                j(),
                  (function () {
                    ...
                    y.length < 10 || y.splice(0, 1),
                      y.push({ time: t, date: o, note: "", abt: M }),
                      w.set("results", y),
                      O(),
                      console.log(M);
                  })();
                ...
                document.querySelector("#adb_test_r").innerHTML =
                  "<span>" +
                  o.cdot +
                  " Total : " +
                  M.total +
          ...
          document
            .querySelector("#start_test")
            .addEventListener("click", () => {
              location.reload(!0);
            });
        var t;
        document
          .querySelector("#d3H_txt")
          .addEventListener("click", function () {
            x(
              "https://raw.githubusercontent.com/Turtlecute33/toolz/master/src/d3host.txt"
            );
          }),
          ((t = "#d3H_adblock"), document.querySelector(t)).addEventListener(
            "click",
            function () {
              x(
